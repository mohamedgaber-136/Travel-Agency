...
export default function HotelDetials() {
  ...
  return (
    ...
    <h3>{hotelObj.title}</h3>
     ...
     <div className='imgStars p-1'><img  src={stars} alt="" /></div>
      <p className='p-1'>5 stars</p>
     </div>
    </div>
      <p className='text-muted'><span><img src={locationIcon} alt="" /></span>{ hotelObj?.location?.address}</p>
     </div>
...
<div class="carousel-inner" style={{
  ...
  <div class="carousel-item active w-100">
    <img src={hotelObj?.photos[0]?.urlTemplate?.replace('{width}','500').replace('{height}','500')} className='w-100' alt="..."/>
  </div>
  <div className="carousel-item w-100">
    <img src={hotelObj?.photos[1]?.urlTemplate?.replace('{width}','500').replace('{height}','500')} className='w-100' alt="..."/>
   
  </div>
  <div className="carousel-item w-100">
    <img src={hotelObj?.photos[2]?.urlTemplate?.replace('{width}','500').replace('{height}','500')} className='w-100' alt="..."/>
  
  </div>
  <div className="carousel-item w-100">
    <img src={hotelObj?.photos[3]?.urlTemplate?.replace('{width}','500').replace('{height}','500')} className='w-100' alt="..."/>
  
  </div>
  </>:<div className="carousel-item w-100">
    <img src={imgHotel} className='w-100' alt="..."/></div>}
</div>
  ...
  <span className="visually-hidden">Next</span>
    ...
    <div>
      ...
      <div className='d-flex flex-wrap gap-3 my-5 '>
        <div className='features pt-3 d-flex flex-column justify-content-between align-items-center  '>
          ...
          <p style={{
            fontSize:'15px',
          }} className='text-muted'>{hotelObj?.numberReviews}</p>
        </div>
        <div className='features-bg bg-transparent  d-flex flex-column justify-content-between align-items-center pt-3 '>
         <img src={star} alt="" />
          <p style={{
            fontSize:'15px',
          }} className=''>Near park</p>
        </div>
        <div className='features-bg bg-transparent d-flex flex-column justify-content-between align-items-center pt-3'>
         <img src={star} alt="" />
          <p style={{
            fontSize:'15px',
          }} className=''>Clean hotel</p>
        </div>
        <div className='features-bg  bg-transparent d-flex flex-column justify-content-between align-items-center pt-3'>
         <img src={star} alt="" />
          <p style={{
            fontSize:'15px',
          }} className=''>Near theater  </p>
        </div>
      </div>
    </div>
    <hr className='my-5'/>
    ...
    <h4>Amenities</h4>
     ...
     <ul className='list-unstyled d-flex flex-column gap-4 col-6'>
        <li><i class="fa-solid fa-door-open"></i>  <span className='text-muted'>Outdoor</span></li>
        <li><i class="fa-solid fa-person-swimming"></i>  <span className='text-muted'>Open pool</span></li>
        <li><i class="fa-solid fa-spa"></i>  <span className='text-muted'>Spa and wellness center</span></li>
        <li><i class="fa-solid fa-utensils"></i>  <span className='text-muted'>Restaurant</span></li>
        <li><i class="fa-solid fa-bell"></i>  <span className='text-muted'>Room servies</span></li>
       
      </ul>
      <ul className='list-unstyled d-flex flex-column gap-4 '>
        <li><i class="fa-solid fa-dumbbell"></i>  <span className='text-muted'>Fitness room</span></li>
        <li><i class="fa-solid fa-martini-glass"></i>  <span className='text-muted'>Bar\Lounage</span></li>
        <li><i class="fa-solid fa-wifi"></i>  <span className='text-muted'>Free wifi</span></li>
        <li><i class="fa-solid fa-mug-hot"></i>  <span className='text-muted'>Tea\Caffea machine</span></li>
    ...
    <h4>Reviews</h4>
      <p className='text-muted'>
      {hotelObj?.numberReviews } verified reviews
      </p>
      <hr className='my-3'/>
      <div>
