...
function LoginPage() {
  ...
  return (
 <div className='container signInContainer bg-danger d-flex justify-content-center align-items-center gap-3 h-100'>
    <div className='imgContainer'>
                   <img src={img} className='' alt='' style={{width:'100%',height:'100%' ,}}/>
                </div>
   ...
   <h2 className='m-0'>Login</h2>
    ...
    </p><p class="p line">Or login With</p>
